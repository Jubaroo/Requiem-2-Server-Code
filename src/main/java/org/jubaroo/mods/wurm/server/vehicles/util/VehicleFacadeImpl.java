...
public class VehicleFacadeImpl implements VehicleFacade {
    ...
    private static final Field embarksString;
    private static final Field maxSpeed;
    private static final Method setWindImpact;
    private static final Field canHaveEquipment;
    private static final Field pilotName;
    ...
    static {
        try {
            ...
            pilotName = ReflectionUtil.getField(Vehicle.class, "pilotName");
    ...
    @Override
    public void setEmbarksString(String string) {
        setPrivateField(embarkString, string);
    }
