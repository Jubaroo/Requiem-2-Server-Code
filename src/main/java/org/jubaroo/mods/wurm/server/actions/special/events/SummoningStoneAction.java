        ...
        try {
            if (performer instanceof Player) {
                ...
                if (source.getTemplateId() == ItemList.bodyHand) {
                    ...
                    comm.sendServerMessage(String.format("Red Dragon's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(redDragonSummonItem), ItemTemplateFactory.getInstance().getTemplate(redDragonSummonItem).getName(), redDragonSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Blue Dragon's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(blueDragonSummonItem), ItemTemplateFactory.getInstance().getTemplate(blueDragonSummonItem).getName(), blueDragonSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("White Dragon's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(whiteDragonSummonItem), ItemTemplateFactory.getInstance().getTemplate(whiteDragonSummonItem).getName(), whiteDragonSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Green Dragon's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(greenDragonSummonItem), ItemTemplateFactory.getInstance().getTemplate(greenDragonSummonItem).getName(), greenDragonSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Black Dragon's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(blackDragonSummonItem), ItemTemplateFactory.getInstance().getTemplate(blackDragonSummonItem).getName(), blackDragonSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Red Dragon Hatchling's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(redDragonHatchlingSummonItem), ItemTemplateFactory.getInstance().getTemplate(redDragonHatchlingSummonItem).getName(), redDragonHatchlingSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Blue Dragon Hatchling's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(blueDragonHatchlingSummonItem), ItemTemplateFactory.getInstance().getTemplate(blueDragonHatchlingSummonItem).getName(), blueDragonHatchlingSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("White Dragon Hatchling's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(whiteDragonHatchlingSummonItem), ItemTemplateFactory.getInstance().getTemplate(whiteDragonHatchlingSummonItem).getName(), whiteDragonHatchlingSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Green Dragon Hatchling's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(greenDragonHatchlingSummonItem), ItemTemplateFactory.getInstance().getTemplate(greenDragonHatchlingSummonItem).getName(), greenDragonHatchlingSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Black Dragon Hatchling's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(blackDragonHatchlingSummonItem), ItemTemplateFactory.getInstance().getTemplate(blackDragonHatchlingSummonItem).getName(), blackDragonHatchlingSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Troll King's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(trollKingSummonItem), ItemTemplateFactory.getInstance().getTemplate(trollKingSummonItem).getName(), trollKingSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Goblin Leader's desire %s copper %s.", RequiemUtilities.a_an_FromTemplateId(goblinLeaderSummonItem), ItemTemplateFactory.getInstance().getTemplate(goblinLeaderSummonItem).getName()), 0, 255, 0);
                    comm.sendServerMessage(String.format("Kyklops's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(kyklopsSummonItem), ItemTemplateFactory.getInstance().getTemplate(kyklopsSummonItem).getName(), kyklopsSummonItemQuality), 0, 255, 0);
                    comm.sendServerMessage(String.format("Forest Giant's desire %s %s at %s quality.", RequiemUtilities.a_an_FromTemplateId(forestGiantSummonItem), ItemTemplateFactory.getInstance().getTemplate(forestGiantSummonItem).getName(), forestGiantSummonItemQuality), 0, 255, 0);
                    return propagate(action, ActionPropagation.FINISH_ACTION, ActionPropagation.NO_SERVER_PROPAGATION, ActionPropagation.NO_ACTION_PERFORMER_PROPAGATION);
                }
