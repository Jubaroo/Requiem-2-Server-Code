...
public class JoustAction implements ModAction {
    ...
    public JoustAction(int damage, int basehitchance, int spearskillrange, int bonuslancedamage, int losehemletchance, float perkmdamageboost, boolean allowskillgain, float lancerange) {
        ...
        LanceID = CustomItems.joustingLanceId;
        LanceDamage = damage;
    ...
    public BehaviourProvider getBehaviourProvider() {
        return new BehaviourProvider() {
            ...
            public List<ActionEntry> getBehavioursFor(Creature performer, Item subject, Creature target) {
                try {
                    if ((performer.getRighthandItem().getTemplateId() == LanceID && target.getRighthandItem().getTemplateId() == LanceID) &&
                            (performer.isPlayer() && target.isPlayer()) &&
