...
public class PreInitialize {
    ...
    public static void preInit() throws NotFoundException, CannotCompileException {
        ...
        try {
            ...
            RequiemLogging.logException("[ERROR] Scaling horse speed", e);
        }
        ...
        try {
            ...
            RequiemLogging.logException("[ERROR] Force mount speed change check on damage", e);
        }
        ...
        try {
            ...
            RequiemLogging.logException("[ERROR] Change HotA reward", e);
        }
        ...
        try {
            ...
            RequiemLogging.logException("[ERROR] Display discord message for HotA wins", e);
        }
        ...
        try {
            ...
            RequiemLogging.logException("[ERROR] Display discord message for HotA conquers & neutralizes", e);
        }
        ...
        try {
            ...
            String desc7 = Descriptor.ofMethod(CtClass.booleanType, params);
            ...
            RequiemLogging.logException("[ERROR] Announce digging up artifacts on Discord", e);
        }
        ...
        try {
            ...
            RequiemLogging.logException("[ERROR] Show Custom Slash Commands In /help Readout", e);
        }
        ...
        try {
            Util.setReason("Auto-DarkGenesis a creature born on enchanted grass");
        ...
        try {
            ...
            replace = String.format("if(%s.isRareCreature($3)){  $2.getCommunicator().sendNormalServerMessage(\"This creature is immune to Worm Brains.\");  return false;}", CreatureTweaks.class.
        ...
        if (enableNewPlayerQuestion) {
            try {
                ...
                RequiemLogging.logException("[ERROR] in hooking into handleLogin", e);
            }
        }
        ...
        if (enableAthanorMechanism) {
            try {
                ...
                RequiemLogging.logException("[ERROR] in hooking into sendAltarsToPlayer", e);
            }
        }
