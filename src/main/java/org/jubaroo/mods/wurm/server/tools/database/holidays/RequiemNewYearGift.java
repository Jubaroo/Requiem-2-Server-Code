...
public class RequiemNewYearGift {
    ...
    public static void onPlayerLogin(Player player) {
        ...
        try {
            ...
            ps = dbcon.prepareStatement("SELECT * FROM RequiemNewYearGift");
            ...
            if (!steamIdGifted & !thisYear) {
                RequiemLogging.logInfo("Player " + player.getName() + " has not been gifted this year, giving RequiemNewYearGift now...");
                dbcon = ModSupportDb.getModSupportDb();
                ps = dbcon.prepareStatement("INSERT INTO RequiemNewYearGift (NAME,STEAMID,GIFTEDYEAR) VALUES(?,?,?)");
    ...
    public static void onServerStarted() {
        try {
            ...
            String sql;
            String tableName = "RequiemNewYearGift";
