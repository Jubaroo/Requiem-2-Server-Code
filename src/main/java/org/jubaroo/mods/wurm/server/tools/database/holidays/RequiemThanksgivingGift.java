...
public class RequiemThanksgivingGift {
    ...
    public static void onPlayerLogin(Player player) {
        ...
        try {
            ...
            ps = dbcon.prepareStatement("SELECT * FROM RequiemThanksgivingGift");
            ...
            if (!steamIdGifted & !thisYear) {
                RequiemLogging.logInfo("Player " + player.getName() + " has not been gifted this year, giving RequiemThanksgivingGift now...");
                dbcon = ModSupportDb.getModSupportDb();
                ps = dbcon.prepareStatement("INSERT INTO RequiemThanksgivingGift (NAME,STEAMID,GIFTEDYEAR) VALUES(?,?,?)");
    ...
    public static void onServerStarted() {
        try {
            ...
            String sql;
            String tableName = "RequiemThanksgivingGift";
    ...
    private static void giveItems(Player player) {
        try {
            ...
            player.getInventory().insertItem(turkey, true);
