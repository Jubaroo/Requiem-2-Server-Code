...
public class RequiemIndependenceDayGift {
    ...
    public static void onPlayerLogin(Player player) {
        ...
        try {
            ...
            ps = dbcon.prepareStatement("SELECT * FROM RequiemIndependenceDayGift");
            ...
            if (!steamIdGifted & !thisYear) {
                RequiemLogging.logInfo("Player " + player.getName() + " has not been gifted this year, giving RequiemIndependenceDayGift now...");
                dbcon = ModSupportDb.getModSupportDb();
                ps = dbcon.prepareStatement("INSERT INTO RequiemIndependenceDayGift (NAME,STEAMID,GIFTEDYEAR) VALUES(?,?,?)");
    ...
    public static void onServerStarted() {
        try {
            ...
            String sql;
            String tableName = "RequiemIndependenceDayGift";
