...
public class ScrollOfVillageWarAction implements ModAction, ActionPerformer, BehaviourProvider {
    private final ActionEntry actionEntry;
    private final String actStrVerb = "reading";
    private final int item = CustomItems.scrollOfVillageWar.getTemplateId();
    private static final NumberFormat nf = NumberFormat.getInstance();

    public ScrollOfVillageWarAction() {
